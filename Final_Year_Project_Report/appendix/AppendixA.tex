...
\clearpage
Figures~\ref{fig:screen_market_overview_app}--\ref{fig:screen_stock_analysis_app} reproduce two principal dashboard screens from the running build (see also Section~\ref{sec:frontend_screenshots}).

\begin{figure}[H]
  \centering
  \IfFileExists{figures/screen_market_overview.png}{%
    \includeDashboardShot[\linewidth]{screen_market_overview.png}}{%
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.5em}Market Overview screenshot (\texttt{figures/screen\_market\_overview.png} not found).\vspace{1.5em}}}}
  \caption{Market Overview page: global sentiment distribution, daily trend, and per-source filter controls.}
  \label{fig:screen_market_overview_app}
\end{figure}

\begin{figure}[H]
  \centering
  \IfFileExists{figures/screen_stock_analysis.png}{%
    \includeDashboardShot[\linewidth]{screen_stock_analysis.png}}{%
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.5em}Stock Analysis screenshot (\texttt{figures/screen\_stock\_analysis.png} not found).\vspace{1.5em}}}}
  \caption{Stock Analysis page: per-ticker sentiment time-series, price overlay, LIME heatmap, and data quality indicators.}
  \label{fig:screen_stock_analysis_app}
\end{figure}
