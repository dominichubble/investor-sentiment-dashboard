...
class FinBERTModel:
    ...
    def predict(
        self, text: Union[str, List[str]], return_all_scores: bool = False
        ...
        try:
            ...
            for pred in predictions:
                scores_dict = {
                    label: float(score) for label, score in zip(self.LABELS, pred)
                }
    ...
    def predict_batch(
        self, texts: List[str], batch_size: int = 32, return_all_scores: bool = False
    ) -> List[Dict]:
        """
